...
Pod::Spec.new do |s|
  s.name             = 'Songs'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Songs.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ruanvictorreis/Songs'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ruanvictorreis' => 'ruanvictorreis@gmail.com' }
  s.source           = { :git => 'https://github.com/ruanvictorreis/Songs.git', :tag => s.version.to_s }
